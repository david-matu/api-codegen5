...
$(document).ready(function(){
	$('.delete-btn').on('click', function(ev){
    	  ...
    	  var fname = $(this).attr('data-asset-name');
    	  var entityID = $(this).attr('data-id');
    	  var targetTab = $(this).attr('data-table');
    	  var primCol = $(this).attr('data-key');
    	  var actionTaken = confirm("Are you sure you want to delete\n" + fname  + "?\n");
    		  ...
    		  $.post(targetURL, 
    	    			{
    	    			  ...
    	    			  function(data){
    	    		  		if(data === 'DELETE_OKAY'){
    	    		  			...
    	    		  			alert('Error, could not delete ' + fname);
    	    		  		}
    	    	  });  
    	  } else {
    	  }
