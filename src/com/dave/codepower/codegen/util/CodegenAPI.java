...
public class CodegenAPI {
	...
	public static String createAPIEntityService(String modelName, String groupID, List<String> attributeList, Map<String, String> modelAttributeMap) {
		...
		sb.append("\t\t" + fLetter + ".set" + CodeUtil.capitalize(attributeList.get(0)) + "(appDAO().getUniqueIntegerItemID());\n");	//There's a SQL function to get unique IDs, change as appropriate
	 ...
	 */
	public static String generateConfigFile(String projectName, int port) {
		String fin = "";
		StringBuilder sb = new StringBuilder();
		...
		sb.append("logging:\r\n"
				...
				+ "  \r\n"
				+ "swagger:\r\n"
				+ "  resourcePackage: com.dave.apis." + projectName + ".resources");
